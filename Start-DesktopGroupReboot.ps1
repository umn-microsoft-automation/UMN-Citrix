...
.EXAMPLE
    .\start-desktopgroupreboot.ps1 -AdminAddress "mydc.domain.org" -DesktopGroupName "My Desktops" -PercentToRemain 80 -WaitForRegisterInterval 180
.EXAMPLE
    .\start-desktopgroupreboot.ps1 -AdminAddress "mydc.domain.org" -DesktopGroupName "My Desktops" -PercentToRemain 20 -LogoffDisconnected $true
.NOTES
